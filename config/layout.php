...
return [
    ...
    'resources' => [
        ...
        'css' => [
            'theme_assets/plugins/global/plugins.bundle.css',
            'theme_assets/plugins/custom/prismjs/prismjs.bundle.css',
            'theme_assets/css/style.bundle.css',
        ],
        'js' => [
            'theme_assets/plugins/global/plugins.bundle2.js',
            'theme_assets/plugins/custom/prismjs/prismjs.bundle2.js',
            'theme_assets/js/scripts.bundle2.js',
        ],
    ],
