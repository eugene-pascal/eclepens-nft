<div class="flex-row-fluid ml-lg-8">
    ...
    <div class="card card-custom">
        ...
        <form
                method="POST"
                action="{{ route('member.profile', ['member' => $member, 'tab'=>'password']) }}"
        ...
        <!--begin::Header-->
            <div class="card-header py-3">
                <div class="card-title align-items-start flex-column">
                    <h3 class="card-label font-weight-bolder text-dark">@lang('Change member password')</h3>
                    <span class="text-muted font-weight-bold font-size-sm mt-1">@lang('Change password of :member', ['member'=>'<span class="font-weight-bolder text-primary">'.$member->getFullName().'</span>'])</span>
                </div>
                <div class="card-toolbar">
                    <button type="submit" class="btn btn-success mr-2">@lang('Submit')</button>
            ...
            <div class="card-body">
            @if(session()->get('successOnUpdate') === true)
                <!--begin::Alert-->
                    <div class="alert alert-custom alert-light-success fade show mb-10" role="alert">
                        ...
                        <div class="alert-text font-weight-bold">{{ __('Password has been updated') }}</div>
            ...
            @if($errors->any())
                ...
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label text-alert">@lang('Password confirmation')</label>
                    <div class="col-lg-9 col-xl-6">
