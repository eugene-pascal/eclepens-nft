    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{ route('settings.site.add') }}" class="btn btn-light-primary font-weight-normal">
...
@section('scripts')
    ...
    <script>
        var HOST_URL = "{{ route('ktdatatable.settings.sites.list') }}";
        var USER_TYPE = 'user';
    </script>
            ...
            var start = function() {
                var dtConfig = {
                    ...
                    columns: [{
                        ...
                        width: 75,
                        template: function(row) {
                            return '<span class="text-primary font-weight-normal font-size-sm">' + row.code + '</span>';
                        },
                    }, {
                        field: 'status',
                        title: 'Status',
                        ...
                        autoHide: false,
                        template: function(row) {
                            var _link = '{!! route("settings.site.edit",["site"=>':id']) !!}';
