...
<head>
    ...
    <link href="{{ asset('theme_assets/css/pages/login/login-2.css') }}"" rel="stylesheet" type="text/css" />
...
<script src="{{ asset('theme_assets/js/pages/custom/login/login-general.js?3') }}"></script>
